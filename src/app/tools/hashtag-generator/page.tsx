...
export default function AIWriterPage() {
  const customFields = {
    topic: {
      type: 'input' as const,
      label: 'Tema',
      placeholder: 'Skriv inn temaet for hashtaggene'
    },
    platform: {
      type: 'input' as const,
      label: 'Plattform',
      placeholder: 'Hvilken sosial medieplattform skal hashtaggene brukes på?'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Hashtag Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Hashtag Generator hjelper deg å skape unike og relevante hashtags raskt og enkelt. Med dette verktøyet kan du generere kreative hashtag-forslag tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over relevante og unike hashtags basert på den gitte informasjonen. *Hashtaggene skal være tilpasset det spesifiserte temaet og optimalisert for den angitte sosiale medieplattformen. Generer minst 10 hashtags, inkludert en blanding av populære og nisje-spesifikke hashtags. Sørg for at hashtaggene er kreative, engasjerende og har potensial til å øke synligheten av innholdet.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Hashtag Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Hashtag Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og relevante hashtags basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne de perfekte hashtags for sosiale medier, kampanjer, eller andre formål, raskt og effektivt.
          </p>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-hashtag generator som skaper unike hashtags
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-hashtag generator er ikke en hvilken som helst generator. Den er designet for å levere kontekstuelt relevante og unike hashtags som stemmer overens med dine spesifikke behov. Med vår AI-hashtag generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike hashtags basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange hashtag-forslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i hashtag-prosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-hashtag generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer hashtags med et verktøy som forstår kontekst og skaper originale, unike hashtags! Vår AI-hashtag generator er et verktøy du kan stole på for å produsere kreative og passende hashtags av høy kvalitet.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike hashtags</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer hashtags kan AI-hashtag generatoren lage?",
    answer: "Vår AI-hashtag generator er allsidig og kan generere et bredt utvalg av hashtags. Dette inkluderer populære hashtags, nisje-hashtags, og til og med kreative, unike hashtags for spesifikke kampanjer eller innlegg."
  },
  {
    question: "Hvordan håndterer AI-hashtag generatoren personvernet ditt?",
    answer: "Vår AI-hashtag generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte hashtags er til din eksklusive bruk."
  },
  {
    question: "Kan AI-hashtag generatoren din skape hashtags basert på spesifikke kriterier?",
    answer: "Ja, vår AI-hashtag generator kan justere hashtag-forslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at hashtaggen skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-hashtag generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-hashtag generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende hashtags."
  },
  {
    question: "Kan AI-hashtag generatoren din hjelpe med å finne sjeldne eller unike hashtags?",
    answer: "Ja, vår AI-hashtag generator er designet for å skape både vanlige og unike hashtags. Du kan justere innstillingene for å generere sjeldnere eller mer unike hashtag-forslag."
  },
  {
    question: "Kan jeg bruke AI-hashtag generatoren for å finne hashtags fra forskjellige kulturer?",
