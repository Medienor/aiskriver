...
export default function AIWriterPage() {
  const customFields = {
    rapStyle: {
      type: 'input' as const,
      label: 'Rap stil',
      placeholder: 'F.eks. Old School, Trap, Conscious, etc.'
    },
    theme: {
      type: 'textarea' as const,
      label: 'Tema eller budskap',
      placeholder: 'Beskriv hovedtemaet eller budskapet i rapteksten'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center mx-auto">AI Rap Sangtekst Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Rap Sangtekst Generator er et kraftig verktøy som hjelper deg å lage skreddersydde raptekster på kort tid. Den sparer deg for timer med arbeid og sikrer at dine tekster er både kreative og fengende.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en kreativ og fengende raptekst basert på den gitte informasjonen. *Teksten skal være på norsk, tilpasset den spesifiserte rapstilen, og reflektere det angitte temaet eller budskapet. Vær kreativ, bruk relevante metaforer og ordspill, og sørg for at teksten har en god flyt og rytme som passer til rap.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Rap Sangtekst Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Rap Sangtekst Generator er et avansert verktøy som bruker kunstig intelligens for å produsere skreddersydde raptekster basert på gitte instruksjoner. Dette verktøyet kan hjelpe deg med å skape kreative og fengende tekster raskt og effektivt, tilpasset din stil og preferanser.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Skriv inn dine preferanser</p>
              </div>
              ...
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg stil og tema</p>
              </div>
              <div className="hidden md:block text-[#06f] dark:text-blue-400 text-2xl">→</div>
              <div className="flex-1 text-center">
                <div className="bg-[#06f] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">3</div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Få din skreddersydde raptekst</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-drevet rap sangtekst generator som skaper kreativitet og originalitet
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Rap Sangtekst Generator er ikke en hvilken som helst tekstgenerator. Det er et spesialisert verktøy designet for å levere kreative, fengende og originale raptekster som stemmer overens med dine spesifikke stil og preferanser. Med vår generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere skreddersydde raptekster som er tilpasset din stil og preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Skape kreative og fengende tekster som imponerer publikum.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og ressurser ved å automatisere prosessen med å lage og oppdatere raptekster.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Originalitet</span> AI-rap sangtekst generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer raptekster med et verktøy som forstår kreativitet og skaper originale, fengende tekster! Vår AI Rap Sangtekst Generator er et verktøy du kan stole på for å produsere tekster av høy kvalitet som er unike og tilpasset dine preferanser.
            </p>
...
const faqs = [
  {
    question: "Hvorfor trenger jeg en rap sangtekst generator?",
    answer: "En rap sangtekst generator er viktig for å skape kreative og fengende tekster, redusere tid brukt på skriving og sikre at dine tekster er unike og tilpasset din stil. Den kan også hjelpe deg med å overvinne skrivesperre og inspirere til nye ideer."
  },
  {
    question: "Hvordan sikrer AI Rap Sangtekst Generatoren at tekstene er originale?",
    answer: "Vår AI er trent på et bredt spekter av tekster og oppdateres jevnlig. Den bruker avanserte algoritmer for å generere unike og kreative tekster basert på dine preferanser. Likevel anbefaler vi alltid å gjennomgå tekstene for å sikre at de perfekt reflekterer din stil og budskap."
  },
  {
    question: "Kan jeg tilpasse rapteksten etter at den er generert?",
    answer: "Ja, absolutt. Etter at AI-en har generert en grunnleggende tekst, kan du redigere og tilpasse den etter dine spesifikke behov. Du kan legge til, fjerne eller endre seksjoner for å sikre at teksten perfekt reflekterer din stil og budskap."
  },
  {
    question: "Hvor ofte bør jeg oppdatere mine raptekster?",
    answer: "Det er lurt å gjennomgå og oppdatere dine raptekster jevnlig, spesielt når du får nye ideer eller ønsker å endre stil. Vår AI-generator gjør det enkelt å oppdatere tekstene dine raskt og effektivt."
  },
  {
    question: "Kan AI Rap Sangtekst Generatoren lage tekster for ulike sjangre?",
