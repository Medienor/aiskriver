...
export default function AIWriterPage() {
  const customFields = {
    productName: {
      type: 'input' as const,
      label: 'Produktnavn',
      placeholder: 'Skriv inn produktnavnet'
    },
    productFeatures: {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Flipkart Produktbeskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Flipkart Produktbeskrivelse Generator hjelper deg å skape unike og engasjerende produktbeskrivelser raskt og enkelt. Med dette verktøyet kan du generere kreative produktbeskrivelser tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en overbevisende og detaljert produktbeskrivelse for Flipkart basert på den gitte informasjonen. *Beskrivelsen skal være på norsk, SEO-vennlig, og fremheve produktets unike egenskaper. Inkluder viktige detaljer som materiale, størrelse, bruksområder og fordeler. Sørg for at beskrivelsen er engasjerende og selgende, men samtidig faktabasert og ærlig.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Flipkart Produktbeskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Flipkart Produktbeskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og engasjerende produktbeskrivelser basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte produktbeskrivelsen for din nettbutikk, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din produktbeskrivelse!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-produktbeskrivelse generator som skaper unike tekster
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-produktbeskrivelse generator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og unike produktbeskrivelser som stemmer overens med dine spesifikke behov. Med vår AI-produktbeskrivelse generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike produktbeskrivelser basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange produktbeskrivelsesforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer produktbeskrivelser med et verktøy som forstår kontekst og skaper originale, unike tekster! Vår AI-produktbeskrivelse generator er et verktøy du kan stole på for å produsere kreative og passende produktbeskrivelser av høy kvalitet.
            </p>
...
const faqs = [
  {
    ...
    answer: "Vår AI-produktbeskrivelse generator er allsidig og kan generere et bredt utvalg av produktbeskrivelser. Dette inkluderer detaljerte, kreative og til og med SEO-optimaliserte produktbeskrivelser for din nettbutikk."
  },
  {
    question: "Hvordan håndterer AI-produktbeskrivelse generatoren personvernet ditt?",
    answer: "Vår AI-produktbeskrivelse generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte produktbeskrivelser er til din eksklusive bruk."
  },
  {
    question: "Kan AI-produktbeskrivelse generatoren din skape tekster basert på spesifikke kriterier?",
    answer: "Ja, vår AI-produktbeskrivelse generator kan justere tekstforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tone, eller til og med bestemte ord du vil at teksten skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-produktbeskrivelse generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-produktbeskrivelse generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende produktbeskrivelser."
  },
  {
    question: "Kan AI-produktbeskrivelse generatoren din hjelpe med å finne unike produktbeskrivelser?",
