...
export default function AIWriterPage() {
  const customFields = {
    nameOrigin: {
      type: 'input' as const,
      label: 'Ønsket opprinnelse',
      placeholder: 'F.eks. norsk, tysk, italiensk'
    },
    nameLength: {
      type: 'input' as const,
      label: 'Ønsket lengde',
      placeholder: 'Kort, medium, eller langt'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Etternavn Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Etternavn Generator hjelper deg å skape unike og passende etternavn raskt og enkelt. Med dette verktøyet kan du generere kreative etternavnsforslag tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over unike og passende etternavn basert på den gitte informasjonen. *Etternavnene skal være kreative, relevante for den ønskede opprinnelsen, og tilpasset den angitte lengden. Sørg for at navnene er realistiske og kan brukes i virkelige situasjoner. Generer minst 10 forskjellige etternavnsforslag.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Etternavn Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Etternavn Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og passende etternavn basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne det perfekte etternavnet for karakterer, fiktive personer, eller til og med for personlig bruk, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg ditt etternavn!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-etternavngenerator som skaper unike navn
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-etternavngenerator er ikke en hvilken som helst navngenerator. Den er designet for å levere kontekstuelt relevante og unike etternavn som stemmer overens med dine spesifikke behov. Med vår AI-etternavngenerator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike etternavn basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange etternavnsforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i navngivningsprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-etternavngenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer etternavn med et verktøy som forstår kontekst og skaper originale, unike navn! Vår AI-etternavngenerator er et verktøy du kan stole på for å produsere kreative og passende etternavn av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer etternavn kan AI-etternavngeneratoren lage?",
    answer: "Vår AI-etternavngenerator er allsidig og kan generere et bredt utvalg av etternavn. Dette inkluderer tradisjonelle norske etternavn, internasjonale etternavn, og til og med kreative, fiktive etternavn for karakterer i bøker eller spill."
  },
  {
    question: "Hvordan håndterer AI-etternavngeneratoren personvernet ditt?",
    answer: "Vår AI-etternavngenerator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte etternavn er til din eksklusive bruk."
  },
  {
    question: "Kan AI-etternavngeneratoren din skape navn basert på spesifikke kriterier?",
    answer: "Ja, vår AI-etternavngenerator kan justere navneforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, opprinnelse, eller til og med bestemte bokstaver du vil at navnet skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-etternavngeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-etternavngenerator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende etternavn."
  },
  {
