...
export default function AIWriterPage() {
  const customFields = {
    targetAudience: {
      type: 'input' as const,
      label: 'Målgruppe',
      placeholder: 'Beskriv din målgruppe for e-postlisten'
    },
    industryKeywords: {
      type: 'textarea' as const,
      label: 'Bransjenøkkelord',
      placeholder: 'Legg inn relevante nøkkelord for din bransje'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Epost Leads Generator</h1>
        <p className="text-sm mb-6 md:mb-12 text-gray-500 dark:text-gray-400 mx-auto text-center max-w-2xl">
          Vår AI Epost Leads Generator hjelper deg å finne potensielle kunder og generere e-postlister for din bedrift. Med avansert kunstig intelligens kan du raskt identifisere og kontakte relevante leads som matcher din målgruppe.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste med potensielle kunder og e-postadresser basert på den gitte målgruppen og bransjenøkkelordene. *Generer en variert liste med relevante leads som passer til beskrivelsen. Inkluder fiktive navn, e-postadresser, firmanavn, og en kort beskrivelse av hvorfor de er relevante leads. Sørg for at e-postadressene følger et realistisk format, men er tydelig fiktive.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Epost Leads Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Epost Leads Generator er et avansert verktøy som bruker kunstig intelligens for å identifisere og generere potensielle kunder basert på dine spesifikasjoner. Dette verktøyet kan hjelpe deg med å finne de riktige kontaktene for din bedrift raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Få din e-postliste!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Epost Leads Generator som tenker som en markedsføringsekspert
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Innhold.AI er ikke en hvilken som helst epost leads generator. Det er en avansert AI-drevet assistent designet for å levere relevante og kvalifiserte leads som stemmer overens med din målgruppe og forretningsmål. Med Innhold.AI kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere kvalifiserte leads som reflekterer din målgruppe.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få flere alternativer på sekunder, spar tid og ressurser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Utforske nye markeder og kundegrupper du kanskje ikke hadde tenkt på selv.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Epost Leads Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer epost leads med et verktøy som forstår din målgruppe og skaper originale, kvalifiserte forslag! Innhold.AI er en AI Epost Leads Generator du kan stole på for å produsere relevante og kvalifiserte leads som skiller seg ut i mengden.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Kvalitet</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer leads kan AI Epost Leads Generatoren lage?",
    answer: "Vår AI Epost Leads Generator er allsidig og kan generere et bredt utvalg av leads. Dette inkluderer kvalifiserte leads, potensielle kunder, og kontakter med høy relevans for din bedrift."
  },
  {
    question: "Hvordan håndterer AI Epost Leads Generatoren personvernet ditt?",
    answer: "Innhold.AI er designet med tanke på personvern. Den deler ikke dine personlige data eller søkeord med ikke-relaterte parter uten ditt samtykke. Alle genererte leads eies utelukkende av deg."
  },
  {
    question: "Kan AI Epost Leads Generatoren din ta hensyn til spesifikke bransjer eller nisjer?",
    answer: "Ja, vår AI Epost Leads Generator kan tilpasse forslagene basert på din spesifikke bransje eller nisje. Du kan angi nøkkelord eller beskrivelser relatert til din virksomhet, og AI-en vil generere relevante leads."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Epost Leads Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke Innhold.AI. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kvalifiserte leads."
  },
  {
    question: "Kan AI Epost Leads Generatoren din hjelpe med å finne leads som er SEO-vennlige?",
    answer: "Ja, vår AI Epost Leads Generator kan generere leads som er SEO-vennlige. Den kan inkludere relevante nøkkelord og skape kontakter som er lette å finne og kontakte, noe som kan forbedre din online synlighet."
  },
  {
