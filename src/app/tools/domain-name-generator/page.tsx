...
export default function AIWriterPage() {
  const customFields = {
    businessDescription: {
      ...
      label: 'Beskriv din bedrift eller prosjekt',
      placeholder: 'Gi en kort beskrivelse av din bedrift, prosjekt eller idé'
    },
    targetAudience: {
      type: 'input' as const,
      label: 'Målgruppe',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Domenenavn Generator</h1>
        <p className="text-sm mb-6 md:mb-12 text-gray-500 dark:text-gray-400 mx-auto text-center max-w-2xl">
          Vår AI Domenenavn Generator hjelper deg å finne unike og passende domenenavn for ditt prosjekt. Med avansert kunstig intelligens kan du raskt generere kreative forslag som matcher din visjon og merkevare.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere kreative, relevante og minneverdige domenenavn basert på den gitte informasjonen om bedriften eller prosjektet. *Generer minst 5 unike domenenavn som reflekterer merkevaren, er lette å huske og stave, og passer til målgruppen. Inkluder en blanding av .com, .no og andre relevante toppnivådomener. Vær kreativ og tenk på SEO-vennlighet i forslagene.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Domenenavn Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Domenenavn Generator er et avansert verktøy som bruker kunstig intelligens for å produsere kreative og relevante domenenavn basert på dine spesifikasjoner. Dette verktøyet kan hjelpe deg med å finne det perfekte domenenavnet for din nettside, bedrift eller prosjekt raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg ditt domenenavn!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-domenenavn generator som tenker som en merkevareekspert
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Innhold.AI er ikke en hvilken som helst domenenavn generator. Det er en avansert AI-drevet assistent designet for å levere kreative, relevante og minneverdige domenenavn som stemmer overens med din merkevare og visjon. Med Innhold.AI kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere unike og catchy domenenavn som reflekterer din merkevare.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-domenenavn generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer domenenavn med et verktøy som forstår din merkevare og skaper originale, unike forslag! Innhold.AI er en AI-domenenavn generator du kan stole på for å produsere kreative og relevante domenenavn som skiller seg ut i mengden.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer domenenavn kan AI-domenenavn generatoren lage?",
    answer: "Vår AI-domenenavn generator er allsidig og kan generere et bredt utvalg av domenenavn. Dette inkluderer korte og catchy navn, beskrivende navn, brandable navn, og domener med populære endelser som .com, .no, .net, og mange flere."
  },
  {
    question: "Hvordan håndterer AI-domenenavn generatoren personvernet ditt?",
    answer: "Innhold.AI er designet med tanke på personvern. Den deler ikke dine personlige data eller søkeord med ikke-relaterte parter uten ditt samtykke. Alle genererte domenenavn eies utelukkende av deg."
  },
  {
    question: "Kan AI-domenenavn generatoren din ta hensyn til spesifikke bransjer eller nisjer?",
    answer: "Ja, vår AI-domenenavn generator kan tilpasse forslagene basert på din spesifikke bransje eller nisje. Du kan angi nøkkelord eller beskrivelser relatert til din virksomhet, og AI-en vil generere relevante domenenavn."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-domenenavn generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke Innhold.AI. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative domenenavn."
  },
  {
