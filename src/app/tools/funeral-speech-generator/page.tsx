...
export default function AIWriterPage() {
  const customFields = {
    relationshipToDeceased: {
      type: 'input' as const,
      label: 'Din relasjon til avdøde',
      placeholder: 'F.eks. sønn, datter, venn, kollega'
    },
    personalMemories: {
      type: 'textarea' as const,
      label: 'Personlige minner',
      placeholder: 'Del noen personlige minner eller historier om den avdøde'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Begravelsesord Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Begravelsesord Generator hjelper deg å skape meningsfulle og trøstende begravelsestaler raskt og enkelt. Med dette verktøyet kan du generere personlige og rørende taler tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en meningsfull og trøstende begravelsestale basert på informasjonen gitt. *Talen skal være på norsk, personlig og tilpasset den avdøde og relasjonen til taleren. Inkluder passende anekdoter, minner og refleksjoner som hedrer den avdødes liv og arv. Tonen skal være respektfull, empatisk og trøstende.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Begravelsesord Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Begravelsesord Generator er et avansert verktøy som bruker kunstig intelligens for å produsere meningsfulle og trøstende begravelsestaler basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne de rette ordene for å uttrykke dine følelser og minne om den avdøde på en verdig måte.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din tale!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-begravelsesordgenerator som skaper meningsfulle taler
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-begravelsesordgenerator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og meningsfulle taler som stemmer overens med dine spesifikke behov. Med vår AI-begravelsesordgenerator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, meningsfulle taler basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange taleforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og energi i taleprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-begravelsesordgenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer begravelsestaler med et verktøy som forstår kontekst og skaper originale, unike taler! Vår AI-begravelsesordgenerator er et verktøy du kan stole på for å produsere kreative og passende taler av høy kvalitet.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike taler</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer taler kan AI-begravelsesordgeneratoren lage?",
    answer: "Vår AI-begravelsesordgenerator er allsidig og kan generere et bredt utvalg av taler. Dette inkluderer meningsfulle, trøstende og personlige taler for begravelser."
  },
  {
    question: "Hvordan håndterer AI-begravelsesordgeneratoren personvernet ditt?",
    answer: "Vår AI-begravelsesordgenerator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte taler er til din eksklusive bruk."
  },
  {
    question: "Kan AI-begravelsesordgeneratoren din skape taler basert på spesifikke kriterier?",
    answer: "Ja, vår AI-begravelsesordgenerator kan justere tale forslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at talen skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-begravelsesordgeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-begravelsesordgenerator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere meningsfulle og passende taler."
  },
  {
    question: "Kan AI-begravelsesordgeneratoren din hjelpe med å finne sjeldne eller unike taler?",
    answer: "Ja, vår AI-begravelsesordgenerator er designet for å skape både vanlige og unike taler. Du kan justere innstillingene for å generere sjeldnere eller mer unike tale forslag."
  },
  {
