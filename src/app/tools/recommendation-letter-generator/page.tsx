...
export default function AIWriterPage() {
  const customFields = {
    personInfo: {
      ...
      placeholder: 'Beskriv personens ferdigheter, erfaringer og prestasjoner'
    },
    letterType: {
      type: 'input' as const,
      label: 'Type anbefalingsbrev',
      placeholder: 'F.eks. jobbsøknad, universitetsopptak, etc.'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center mx-auto">AI Anbefalingbrev Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Anbefalingbrev Generator er et kraftig verktøy som hjelper deg å lage skreddersydde anbefalingbrev på kort tid. Den sparer deg for timer med arbeid og sikrer at ditt brev er både omfattende og lett forståelig.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere et profesjonelt og overbevisende anbefalingsbrev basert på informasjonen gitt. *Brevet skal være på norsk og tilpasses type anbefalingsbrev og personens spesifikke ferdigheter og erfaringer. Vær konkret, fremhev personens styrker, og tilpass tonen til formålet med anbefalingen. Inkluder relevante eksempler og prestasjoner for å styrke anbefalingen.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Anbefalingbrev Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Anbefalingbrev Generator er et avansert verktøy som bruker kunstig intelligens for å produsere skreddersydde anbefalingbrev basert på gitte instruksjoner. Dette verktøyet kan hjelpe deg med å skape klare og omfattende anbefalingbrev raskt og effektivt, tilpasset dine spesifikke behov og krav.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Skriv inn personlige detaljer</p>
              </div>
              ...
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg anbefalingstype</p>
              </div>
              <div className="hidden md:block text-[#06f] dark:text-blue-400 text-2xl">→</div>
              <div className="flex-1 text-center">
                <div className="bg-[#06f] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">3</div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Få ditt skreddersydde brev</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-drevet anbefalingbrev generator som skaper klarhet og tillit
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Anbefalingbrev Generator er ikke en hvilken som helst tekstgenerator. Det er et spesialisert verktøy designet for å levere klare, omfattende og profesjonelle anbefalingbrev som stemmer overens med dine spesifikke behov. Med vår generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere skreddersydde anbefalingbrev som er tilpasset din situasjon og behov.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Skape klare og forståelige brev som bygger tillit hos mottakeren.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og ressurser ved å automatisere prosessen med å lage og oppdatere anbefalingbrev.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Profesjonell kvalitet</span> AI-anbefalingbrev generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer anbefalingbrev med et verktøy som forstår dine behov og skaper klare, omfattende og profesjonelle brev! Vår AI Anbefalingbrev Generator er et verktøy du kan stole på for å produsere brev av høy kvalitet som er i tråd med dine krav.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Profesjonell kvalitet</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvorfor trenger jeg et anbefalingbrev?",
    answer: "Et anbefalingbrev er viktig for å skape tillit hos mottakeren, fremheve dine ferdigheter og erfaringer, og gi en positiv vurdering av din karakter. Det kan også hjelpe deg med å skille deg ut i konkurransen om jobber eller utdanningsmuligheter."
  },
  {
    question: "Hvordan sikrer AI Anbefalingbrev Generatoren at brevet er profesjonelt?",
    answer: "Vår AI er trent på beste praksis for anbefalingbrev og oppdateres jevnlig. Den tar hensyn til din situasjon og behov for å generere et brev som er profesjonelt og overbevisende. Likevel anbefaler vi alltid å få brevet gjennomgått av en person for å sikre full kvalitet."
  },
  {
    question: "Kan jeg tilpasse anbefalingbrevet etter at det er generert?",
    answer: "Ja, absolutt. Etter at AI-en har generert et grunnleggende brev, kan du redigere og tilpasse det etter dine spesifikke behov. Du kan legge til, fjerne eller endre seksjoner for å sikre at brevet perfekt reflekterer dine ferdigheter og erfaringer."
  },
  {
    question: "Hvor ofte bør jeg oppdatere mitt anbefalingbrev?",
    answer: "Det er lurt å gjennomgå og oppdatere ditt anbefalingbrev minst én gang i året, eller når det skjer betydelige endringer i din situasjon eller erfaringer. Vår AI-generator gjør det enkelt å oppdatere brevet ditt raskt og effektivt."
  },
  {
