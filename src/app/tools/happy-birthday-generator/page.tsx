...
export default function AIWriterPage() {
  const customFields = {
    birthdayPerson: {
      type: 'input' as const,
      label: 'Navn på bursdagsbarnet',
      placeholder: 'Skriv inn navnet på personen som har bursdag'
    },
    relationship: {
      type: 'input' as const,
      label: 'Din relasjon til bursdagsbarnet',
      placeholder: 'F.eks. venn, familiemedlem, kollega'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Bursdagstale, dikt og meldings Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Bursdagstale Generator hjelper deg å skape unike og minneverdige bursdagstaler, dikt og meldinger raskt og enkelt. Med dette verktøyet kan du generere kreative og personlige bursdagshilsener tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en personlig og kreativ bursdagshilsen basert på informasjonen gitt. *Hilsenen skal være på norsk og kan være i form av en tale, et dikt eller en melding. Tilpass tonen og innholdet til relasjonen mellom avsender og mottaker. Vær kreativ, hjertevarm og morsom der det passer seg. Inkluder gjerne personlige detaljer hvis de er gitt.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Bursdagstale Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Bursdagstale Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og minneverdige bursdagstaler, dikt og meldinger basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne de perfekte ordene for å feire en spesiell anledning, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din bursdagshilsen!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Bursdagstale Generator som skaper unike hilsener
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Bursdagstale Generator er ikke en hvilken som helst generator. Den er designet for å levere kontekstuelt relevante og unike bursdagstaler, dikt og meldinger som stemmer overens med dine spesifikke behov. Med vår AI Bursdagstale Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike bursdagstaler, dikt og meldinger basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange bursdagshilsener i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i skriveprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Bursdagstale Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer bursdagstaler, dikt og meldinger med et verktøy som forstår kontekst og skaper originale, unike hilsener! Vår AI Bursdagstale Generator er et verktøy du kan stole på for å produsere kreative og passende bursdagshilsener av høy kvalitet.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike hilsener</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer bursdagshilsener kan AI Bursdagstale Generatoren lage?",
    answer: "Vår AI Bursdagstale Generator er allsidig og kan generere et bredt utvalg av bursdagstaler, dikt og meldinger. Dette inkluderer tradisjonelle bursdagshilsener, kreative dikt, og personlige meldinger for enhver anledning."
  },
  {
    question: "Hvordan håndterer AI Bursdagstale Generatoren personvernet ditt?",
    answer: "Vår AI Bursdagstale Generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte hilsener er til din eksklusive bruk."
  },
  {
    question: "Kan AI Bursdagstale Generatoren din skape hilsener basert på spesifikke kriterier?",
    answer: "Ja, vår AI Bursdagstale Generator kan justere hilsene basert på dine preferanser. Du kan spesifisere ønsket tone, lengde, eller til og med bestemte temaer du vil at hilsenen skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Bursdagstale Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Bursdagstale Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende bursdagshilsener."
  },
  {
    question: "Kan AI-etternavngeneratoren din hjelpe med å finne sjeldne eller unike etternavn?",
