...
export default function AIWriterPage() {
  const customFields = {
    productType: {
      type: 'input' as const,
      label: 'Produkttype',
      placeholder: 'F.eks. mobiltelefon, møbel, programvare'
    },
    targetAudience: {
      type: 'textarea' as const,
      label: 'Målgruppe',
      placeholder: 'Beskriv kort hvem produktet er ment for'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Produktfordeler Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Produktfordeler Generator er et kraftfullt verktøy for å skape unike og kreative produktfordeler. Med bare noen få klikk kan du generere en rekke passende fordeler for dine produkter, og spare verdifull tid i prosessen.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over unike og kreative produktfordeler basert på den gitte informasjonen. *Fordelene skal være relevante for produkttypen og målgruppen. Fokuser på å skape overbevisende, konkrete og markedsføringsrettede fordeler som fremhever produktets unike egenskaper. Sørg for at fordelene er varierte og dekker ulike aspekter ved produktet.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Produktfordeler Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Produktfordeler Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og kreative produktfordeler basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å skape passende fordeler raskt og effektivt, enten det er for markedsføring, produktbeskrivelser, eller andre formål.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg dine favorittfordeler</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Produktfordeler Generator som skaper unike fordeler
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Produktfordeler Generator er ikke en hvilken som helst generator. Det er et avansert verktøy designet for å levere kontekstuelt relevante og unike produktfordeler som stemmer overens med dine spesifikke behov. Med vår AI Produktfordeler Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike produktfordeler i en rekke stiler og kategorier.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Lag store mengder produktfordeler i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spar tid og ressurser i produktbeskrivelsesprosessen uten å gå på akkord med kreativiteten.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Produktfordeler Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer unike produktfordeler med et verktøy som forstår kontekst og skaper originale, kreative forslag! Vår AI Produktfordeler Generator er et verktøy du kan stole på for å produsere fordeler av høy kvalitet som skiller seg ut i mengden.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer produktfordeler kan AI Produktfordeler Generatoren lage?",
    answer: "Vår AI Produktfordeler Generator er allsidig og kan generere et bredt utvalg av produktfordeler. Dette inkluderer fordeler for markedsføring, produktbeskrivelser, og mange flere."
  },
  {
    question: "Hvordan håndterer AI Produktfordeler Generatoren personvernet ditt?",
    answer: "Vår AI Produktfordeler Generator er designet med tanke på personvern. Den deler ikke dine personlige data med ikke-relaterte parter uten ditt samtykke. Alle genererte fordeler eies utelukkende av deg."
  },
  {
    question: "Kan AI Produktfordeler Generatoren din lage fordeler i forskjellige stiler?",
    answer: "Ja, vår AI Produktfordeler Generator kan justere fordelstilen basert på dine preferanser. Du kan spesifisere om du ønsker moderne fordeler, klassiske fordeler, eller andre stiler for å få fordeler som passer perfekt til ditt behov."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Produktfordeler Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Produktfordeler Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og unike fordeler."
  },
  {
    question: "Kan AI Produktfordeler Generatoren din hjelpe med å sjekke fordelens tilgjengelighet?",
