...
export default function AIWriterPage() {
  const customFields = {
    productType: {
      type: 'input' as const,
      label: 'Produkttype',
      placeholder: 'F.eks. mobiltelefon, snacks, programvare'
    },
    targetAudience: {
      type: 'input' as const,
      label: 'Målgruppe',
      placeholder: 'F.eks. ungdom, profesjonelle, seniorer'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Produktnavn Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Navne Generator er et kraftfullt verktøy for å skape unike og kreative navn. Med bare noen få klikk kan du generere en rekke passende navn for karakterer, bedrifter eller produkter, og spare verdifull tid i prosessen.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over 10 unike og kreative produktnavn basert på den gitte produkttypen og målgruppen. *Navnene skal være på norsk, relevante for produktet, minneverdige, og appellerende til den spesifiserte målgruppen. Vær kreativ og lag navn som skiller seg ut i markedet.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Produktnavn Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Produktnavn Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og kreative produktnavn basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å skape passende navn raskt og effektivt, enten det er for nye produkter, bedrifter eller karakterer i en bok.
          </p>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Produktnavn Generator som skaper unike navn
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Produktnavn Generator er ikke en hvilken som helst navnegenerator. Det er et avansert verktøy designet for å levere kontekstuelt relevante og unike navn som stemmer overens med dine spesifikke behov. Med vår AI Produktnavn Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike produktnavn i en rekke stiler og kategorier.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Lag store mengder produktnavn i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spar tid og ressurser i navngivningsprosessen uten å gå på akkord med kreativiteten.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Produktnavn Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer unike produktnavn med et verktøy som forstår kontekst og skaper originale, kreative forslag! Vår AI Produktnavn Generator er et verktøy du kan stole på for å produsere navn av høy kvalitet som skiller seg ut i mengden.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer navn kan AI Produktnavn Generatoren lage?",
    answer: "Vår AI Produktnavn Generator er allsidig og kan generere et bredt utvalg av produktnavn. Dette inkluderer navn for nye produkter, bedrifter, karakterer i bøker eller spill, og mange flere."
  },
  {
    question: "Hvordan håndterer AI Produktnavn Generatoren personvernet ditt?",
    answer: "Vår AI Produktnavn Generator er designet med tanke på personvern. Den deler ikke dine personlige data med ikke-relaterte parter uten ditt samtykke. Alle genererte navn eies utelukkende av deg."
  },
  {
    question: "Kan AI Produktnavn Generatoren din lage navn i forskjellige stiler?",
    answer: "Ja, vår AI Produktnavn Generator kan justere navnestilen basert på dine preferanser. Du kan spesifisere om du ønsker moderne navn, klassiske navn, fantasinavn, eller andre stiler for å få navn som passer perfekt til ditt behov."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Produktnavn Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Produktnavn Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og unike navn."
  },
  {
    question: "Kan AI Produktnavn Generatoren din hjelpe med å sjekke navnets tilgjengelighet?",
