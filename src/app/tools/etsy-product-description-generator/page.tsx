...
export default function AIWriterPage() {
  const customFields = {
    productDetails: {
      ...
      placeholder: 'Beskriv ditt produkt, inkludert materiale, størrelse, farge, etc.'
    },
    targetAudience: {
      type: 'input' as const,
      label: 'Målgruppe',
      placeholder: 'Hvem er produktet laget for?'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Etsy Produktbeskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Etsy Produktbeskrivelse Generator hjelper deg med å lage unike og engasjerende produktbeskrivelser for din Etsy-butikk. Med dette kraftfulle verktøyet kan du raskt generere inspirerende beskrivelser tilpasset dine produkter.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere unike og engasjerende produktbeskrivelser for Etsy-produkter basert på den gitte informasjonen. *Beskrivelsene skal være kreative, detaljerte og optimalisert for Etsy-plattformen. Inkluder viktige produktdetaljer, fremhev unike egenskaper, og bruk et språk som appellerer til målgruppen. Sørg for at beskrivelsene er SEO-vennlige og overholder Etsys retningslinjer.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Etsy Produktbeskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Etsy Produktbeskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å lage unike og engasjerende produktbeskrivelser for din Etsy-butikk. Dette verktøyet kan hjelpe selgere med å generere inspirerende beskrivelser raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Få unike produktbeskrivelser!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Etsy Produktbeskrivelse Generator er ikke en hvilken som helst generator. Den er designet for å levere kontekstuelt relevante og kreative beskrivelser som stemmer overens med dine spesifikke behov. Med vår generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere unike og engasjerende produktbeskrivelser for dine produkter.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Skape store mengder produktbeskrivelser i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og inspirere din kreative prosess med AI-genererte beskrivelser.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer produktbeskrivelser med et verktøy som forstår kontekst og skaper originale, unike beskrivelser! Vår AI-produktbeskrivelse generator er et verktøy du kan stole på for å produsere kreative og passende beskrivelser for dine produkter.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer produktbeskrivelser kan generatoren lage?",
    answer: "Vår AI-produktbeskrivelse generator er allsidig og kan generere et bredt utvalg av beskrivelser. Dette inkluderer beskrivelser for håndlagde varer, vintage produkter, kunstverk, og mer. Du kan spesifisere hvilken type produkt du ønsker for best mulig resultat."
  },
  {
    question: "Hvordan håndterer AI-produktbeskrivelse generatoren personvernet ditt?",
    answer: "Vår generator er designet med tanke på personvern. Den deler ikke dine personlige data med ikke-relaterte parter uten ditt samtykke. Alle genererte beskrivelser eies utelukkende av deg."
  },
  {
    question: "Kan AI-produktbeskrivelse generatoren din skape beskrivelser i forskjellige stiler?",
    answer: "Ja, vår AI-produktbeskrivelse generator kan justere beskrivelsesstilen basert på dine preferanser. Du kan spesifisere om du ønsker beskrivelser som høres profesjonelle, kreative, eller annet ut, og generatoren vil tilpasse seg deretter."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-produktbeskrivelse generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative produktbeskrivelser."
  },
  {
    question: "Kan AI-produktbeskrivelse generatoren din hjelpe med å skape konsistente beskrivelser for en hel butikk?",
