...
export default function AIWriterPage() {
  const customFields = {
    jobTitle: {
      ...
      placeholder: 'F.eks. Prosjektleder, Utvikler, Lærer'
    },
    interviewType: {
      type: 'input' as const,
      label: 'Type intervju',
      placeholder: 'F.eks. Jobbintervju, Forskningsintervju, Personlig prosjekt'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Intervju spørsmål Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Intervju spørsmål Generator hjelper deg å skape unike og relevante intervjuspørsmål raskt og enkelt. Med dette verktøyet kan du generere kreative spørsmål tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over relevante og unike intervjuspørsmål basert på den gitte informasjonen. *Spørsmålene skal være på norsk, tilpasset stillingstittel og type intervju. Fokuser på å lage spørsmål som avdekker kandidatens ferdigheter, erfaring og personlighet. Inkluder en blanding av atferdsbaserte spørsmål, situasjonsbaserte spørsmål og faglige spørsmål der det er relevant.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Intervju spørsmål Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Intervju spørsmål Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og relevante intervjuspørsmål basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne de perfekte spørsmålene for jobbintervjuer, forskningsintervjuer, eller til og med for personlige prosjekter, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg dine spørsmål!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-intervjuspørsmålsgenerator som skaper unike spørsmål
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-intervjuspørsmålsgenerator er ikke en hvilken som helst spørsmålsgenerator. Den er designet for å levere kontekstuelt relevante og unike intervjuspørsmål som stemmer overens med dine spesifikke behov. Med vår AI-intervjuspørsmålsgenerator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike intervjuspørsmål basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange spørsmålsforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i spørsmålsprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-intervjuspørsmålsgenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer intervjuspørsmål med et verktøy som forstår kontekst og skaper originale, unike spørsmål! Vår AI-intervjuspørsmålsgenerator er et verktøy du kan stole på for å produsere kreative og passende intervjuspørsmål av høy kvalitet.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike spørsmål</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer intervjuspørsmål kan AI-intervjuspørsmålsgeneratoren lage?",
    answer: "Vår AI-intervjuspørsmålsgenerator er allsidig og kan generere et bredt utvalg av intervjuspørsmål. Dette inkluderer spørsmål for jobbintervjuer, forskningsintervjuer, og til og med kreative spørsmål for personlige prosjekter."
  },
  {
    question: "Hvordan håndterer AI-intervjuspørsmålsgeneratoren personvernet ditt?",
    answer: "Vår AI-intervjuspørsmålsgenerator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte spørsmål er til din eksklusive bruk."
  },
  {
    question: "Kan AI-intervjuspørsmålsgeneratoren din skape spørsmål basert på spesifikke kriterier?",
    answer: "Ja, vår AI-intervjuspørsmålsgenerator kan justere spørsmålsforslagene basert på dine preferanser. Du kan spesifisere ønsket tema, lengde, eller til og med bestemte emner du vil at spørsmålene skal dekke."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-intervjuspørsmålsgeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-intervjuspørsmålsgenerator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende intervjuspørsmål."
  },
  {
    question: "Kan AI-intervjuspørsmålsgeneratoren din hjelpe med å finne sjeldne eller unike spørsmål?",
