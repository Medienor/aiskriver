...
export default function AIWriterPage() {
  const customFields = {
    ...
    hovedIngrediens: {
      type: 'input' as const,
      label: 'Hovedingrediens',
      placeholder: 'F.eks. laks, biff, sjokolade'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Matbeskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Matbeskrivelse Generator hjelper deg å skape unike og detaljerte matbeskrivelser raskt og enkelt. Med dette verktøyet kan du generere kreative matbeskrivelser tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en detaljert og appetittvekkende matbeskrivelse basert på den gitte informasjonen. *Beskrivelsen skal være på norsk, bruke levende og beskrivende språk, og inkludere detaljer om smak, tekstur og presentasjon. Fokuser på å skape en unik og fristende beskrivelse som vekker interesse og appetitt hos leseren.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Matbeskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Matbeskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og detaljerte matbeskrivelser basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte matbeskrivelsen for menyer, oppskrifter, eller til og med for markedsføring, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din matbeskrivelse!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-matbeskrivelse generator som skaper unike tekster
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-matbeskrivelse generator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og unike matbeskrivelser som stemmer overens med dine spesifikke behov. Med vår AI-matbeskrivelse generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike matbeskrivelser basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange matbeskrivelsesforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-matbeskrivelse generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer matbeskrivelser med et verktøy som forstår kontekst og skaper originale, unike tekster! Vår AI-matbeskrivelse generator er et verktøy du kan stole på for å produsere kreative og passende matbeskrivelser av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer matbeskrivelser kan AI-matbeskrivelse generatoren lage?",
    answer: "Vår AI-matbeskrivelse generator er allsidig og kan generere et bredt utvalg av matbeskrivelser. Dette inkluderer detaljerte, kreative og til og med fiktive matbeskrivelser for menyer eller markedsføring."
  },
  {
    question: "Hvordan håndterer AI-matbeskrivelse generatoren personvernet ditt?",
    answer: "Vår AI-matbeskrivelse generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte matbeskrivelser er til din eksklusive bruk."
  },
  {
    question: "Kan AI-matbeskrivelse generatoren din skape tekster basert på spesifikke kriterier?",
    answer: "Ja, vår AI-matbeskrivelse generator kan justere tekstforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at teksten skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-matbeskrivelse generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-matbeskrivelse generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende matbeskrivelser."
  },
  {
    question: "Kan AI-matbeskrivelse generatoren din hjelpe med å finne sjeldne eller unike matbeskrivelser?",
