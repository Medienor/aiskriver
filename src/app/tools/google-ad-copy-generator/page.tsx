...
export default function AIWriterPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Google Annonse Beskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Google Annonse Beskrivelse Generator hjelper deg å lage unike og effektive annonsebeskrivelser raskt og enkelt. Med dette verktøyet kan du generere kreative annonsebeskrivelser tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over effektive og overbevisende Google annonsebeskrivelser basert på den gitte produktinformasjonen og målgruppen. *Hver annonsebeskrivelse skal være unik, fengslende og optimalisert for Google Ads-formatet. Inkluder relevante nøkkelord, fremhev produktets fordeler, og bruk overtalende språk som appellerer til den spesifiserte målgruppen. Begrens hver beskrivelse til maksimalt 90 tegn for overskriften og 90 tegn for beskrivelsen, i tråd med Google Ads' retningslinjer.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Google Annonse Beskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Google Annonse Beskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og effektive annonsebeskrivelser basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte annonsebeskrivelsen for markedsføring, sosiale medier, eller til og med for personlig bruk, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din annonsebeskrivelse!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-annonsegenerator som skaper unike beskrivelser
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-annonsegenerator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og unike annonsebeskrivelser som stemmer overens med dine spesifikke behov. Med vår AI-annonsegenerator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike annonsebeskrivelser basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange annonsebeskrivelsesforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-annonsegenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer annonsebeskrivelser med et verktøy som forstår kontekst og skaper originale, unike tekster! Vår AI-annonsegenerator er et verktøy du kan stole på for å produsere kreative og passende annonsebeskrivelser av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer annonsebeskrivelser kan AI-annonsegeneratoren lage?",
    answer: "Vår AI-annonsegenerator er allsidig og kan generere et bredt utvalg av annonsebeskrivelser. Dette inkluderer kreative, informative og til og med humoristiske annonsebeskrivelser for markedsføring eller sosiale medier."
  },
  {
    question: "Hvordan håndterer AI-annonsegeneratoren personvernet ditt?",
    answer: "Vår AI-annonsegenerator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte annonsebeskrivelser er til din eksklusive bruk."
  },
  {
    question: "Kan AI-annonsegeneratoren din skape tekster basert på spesifikke kriterier?",
    answer: "Ja, vår AI-annonsegenerator kan justere tekstforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at teksten skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-annonsegeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-annonsegenerator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende annonsebeskrivelser."
  },
  {
    question: "Kan AI-annonsegeneratoren din hjelpe med å finne sjeldne eller unike annonsebeskrivelser?",
