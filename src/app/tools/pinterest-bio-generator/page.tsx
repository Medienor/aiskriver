...
export default function AIWriterPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Pinterest Bio Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Pinterest Bio Generator hjelper deg med å lage unike og kreative biografier for din Pinterest-profil. Med dette verktøyet kan du enkelt skape engasjerende innhold som tiltrekker flere følgere.
        </p>
        <AIWriterPanel 
         hiddenPrompt="Din jobb er å skrive en unik og kreativ bio for Pinterest basert på informasjonen du får. Dersom jeg ikke gir deg informasjon om f.eks nøkkelord, tonebruk, målgruppe og språk så betyr det at det ikke er relevant og du skal følge hovedoppgaven din. Dersom du får ekstra informasjon som det vedlagt er det viktig at du implementerer det i svaret ditt."  
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Pinterest Bio Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Pinterest Bio Generator er et avansert verktøy som bruker kunstig intelligens for å lage kreative og unike biografier for din Pinterest-profil. Dette verktøyet hjelper deg med å skape engasjerende innhold som tiltrekker flere følgere og forbedrer din tilstedeværelse på plattformen.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Klikk &quot;Generer bio&quot;</p>
              </div>
              <div className="hidden md:block text-[#06f] dark:text-blue-400 text-2xl">→</div>
              <div className="flex-1 text-center">
                <div className="bg-[#06f] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">3</div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Få din unike bio</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Pinterest Bio Generator som skaper unike biografier
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Pinterest Bio Generator er ikke et vanlig verktøy. Det er en avansert løsning designet for å levere unike, kreative biografier som tiltrekker flere følgere. Med vår AI Pinterest Bio Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Skape engasjerende biografier som tiltrekker flere følgere.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Generere unike biografier raskt og effektivt.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Forbedre din tilstedeværelse på Pinterest med kreative biografier.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unike</span> Pinterest-biografier
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Lag biografier med et verktøy som forstår kontekst og skaper originalt, unikt innhold! Vår AI Pinterest Bio Generator er et verktøy du kan stole på for å produsere biografier av høy kvalitet som tiltrekker flere følgere.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike biografier</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvordan fungerer AI Pinterest Bio Generatoren?",
    answer: "Vår AI Pinterest Bio Generator bruker avansert kunstig intelligens for å analysere og generere biografier. Den forstår konteksten og meningen i den originale informasjonen, og skaper deretter en ny versjon som er unik og engasjerende."
  },
  {
    question: "Er biografiene som genereres av AI Pinterest Bio Generatoren helt unike?",
    answer: "Ja, biografiene som genereres av vår AI Pinterest Bio Generator er designet for å være helt unike. Verktøyet skaper biografier på en måte som gjør dem originale og engasjerende, samtidig som de bevarer den opprinnelige meningen og konteksten."
  },
  {
    question: "Kan AI Pinterest Bio Generatoren håndtere forskjellige typer informasjon og emner?",
    answer: "Absolutt. Vår AI Pinterest Bio Generator er allsidig og kan håndtere en rekke forskjellige informasjonstyper og emner, inkludert personlige interesser, profesjonelle ferdigheter, og mer. Den tilpasser seg konteksten og stilen i den originale informasjonen."
  },
  {
    question: "Hvor nøyaktig er AI Pinterest Bio Generatoren i å bevare den opprinnelige meningen?",
    answer: "Vår AI Pinterest Bio Generator er designet for å bevare den opprinnelige meningen så nøyaktig som mulig. Den analyserer informasjonen grundig for å forstå konteksten og hovedpoengene, og genererer deretter biografier på en måte som beholder disse elementene mens den skaper en unik tekst."
  },
  {
    question: "Kan AI Pinterest Bio Generatoren brukes for profesjonelle profiler?",
