...
export default function AIWriterPage() {
  const customFields = {
    originalText: {
      ...
      label: 'Tekst du vil sjekke',
      placeholder: 'Lim inn teksten du vil endre'
    },
    writingStyle: {
      type: 'input' as const,
      label: 'Ønsket skrivestil',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Plagiat-fjerner</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 w-full md:w-2/3 mx-auto text-center">
          Vår AI Plagiat-fjerner er et kraftfullt verktøy som hjelper deg å omformulere tekst for å unngå plagiering. Med dette verktøyet kan du enkelt skape unikt innhold samtidig som du bevarer den opprinnelige meningen.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å omformulere den originale teksten for å unngå plagiering. *Behold den opprinnelige meningen, men endre setningsstrukturen og ordvalget betydelig. Tilpass stilen basert på den ønskede skrivestilen som er angitt. Sørg for at det omskrevne innholdet er 100% unikt og plagiatfritt, samtidig som det bevarer nøyaktigheten og intensjonen i den originale teksten.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Plagiat-fjerner?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Plagiat-fjerner er et avansert verktøy som bruker kunstig intelligens for å omformulere og omskrive tekst på en måte som eliminerer plagiering. Dette verktøyet hjelper deg med å skape unikt innhold basert på eksisterende tekst, samtidig som du beholder den opprinnelige meningen og konteksten.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center mb-6 md:mb-0">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Klikk &quot;Fjern plagiat&quot;</p>
              </div>
              <div className="hidden md:block text-[#06f] dark:text-blue-400 text-2xl">→</div>
              <div className="flex-1 text-center">
                <div className="bg-[#06f] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">3</div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Få unikt innhold</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Plagiat-fjerner som skaper unikt innhold
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Plagiat-fjerner er ikke en vanlig omskrivingsverktøy. Det er en avansert løsning designet for å levere unikt, plagiatfritt innhold som bevarer den opprinnelige meningen. Med vår AI Plagiat-fjerner kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Omformulere tekst for å unngå plagiering uten å miste meningen.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Skape unikt innhold basert på eksisterende tekster raskt og effektivt.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Forbedre kvaliteten på ditt innhold og unngå problemer med opphavsrett.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Plagiatfri</span> AI-tekstomskriver
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Omskriv tekst med et verktøy som forstår kontekst og skaper originalt, unikt innhold! Vår AI Plagiat-fjerner er en tekstomskriver du kan stole på for å produsere innhold av høy kvalitet som enkelt består plagieringskontroller.
            </p>
...
const faqs = [
  {
    question: "Hvordan fungerer AI Plagiat-fjerneren?",
    answer: "Vår AI Plagiat-fjerner bruker avansert kunstig intelligens for å analysere og omformulere tekst. Den forstår konteksten og meningen i den originale teksten, og skaper deretter en ny versjon som er unik og fri for plagiering, samtidig som den bevarer den opprinnelige meningen."
  },
  {
    question: "Er innholdet som genereres av AI Plagiat-fjerneren helt unikt?",
    answer: "Ja, innholdet som genereres av vår AI Plagiat-fjerner er designet for å være helt unikt. Verktøyet omskriver teksten på en måte som gjør den original og plagiatfri, samtidig som den beholder den opprinnelige meningen og konteksten."
  },
  {
    question: "Kan AI Plagiat-fjerneren håndtere forskjellige typer tekst og emner?",
    answer: "Absolutt. Vår AI Plagiat-fjerner er allsidig og kan håndtere en rekke forskjellige teksttyper og emner, inkludert akademiske tekster, artikler, blogginnlegg, rapporter og mer. Den tilpasser seg konteksten og stilen i den originale teksten."
  },
  {
    question: "Hvor nøyaktig er AI Plagiat-fjerneren i å bevare den opprinnelige meningen?",
    answer: "Vår AI Plagiat-fjerner er designet for å bevare den opprinnelige meningen så nøyaktig som mulig. Den analyserer teksten grundig for å forstå konteksten og hovedpoengene, og omformulerer deretter innholdet på en måte som beholder disse elementene mens den skaper en unik tekst."
  },
  {
    question: "Kan AI Plagiat-fjerneren brukes for akademisk skriving?",
