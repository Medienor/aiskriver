...
export default function AIWriterPage() {
  const customFields = {
    jobTitle: {
      ...
      placeholder: 'F.eks. Seniorkonsulent, Prosjektleder, etc.'
    },
    companyInfo: {
      type: 'textarea' as const,
      label: 'Kort om bedriften',
      placeholder: 'Beskriv kort bedriften og arbeidsmiljøet'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Jobb beskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Jobb beskrivelse Generator hjelper deg å skape unike og passende jobb beskrivelser raskt og enkelt. Med dette verktøyet kan du generere kreative jobb beskrivelsesforslag tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en detaljert og engasjerende jobbeskrivelse basert på den gitte informasjonen. *Beskrivelsen skal være på norsk, profesjonell i tonen, og inkludere viktige elementer som ansvarsområder, kvalifikasjoner, og fordeler ved stillingen. Sørg for at beskrivelsen er tilpasset den spesifikke stillingen og bedriften, og at den tiltrekker seg de rette kandidatene.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Jobb beskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Jobb beskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og passende jobb beskrivelser basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte jobb beskrivelsen for stillingsannonser, rekruttering, eller til og med for intern bruk, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din jobb beskrivelse!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-jobbbeskrivelse generator som skaper unike beskrivelser
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-jobbbeskrivelse generator er ikke en hvilken som helst generator. Den er designet for å levere kontekstuelt relevante og unike jobb beskrivelser som stemmer overens med dine spesifikke behov. Med vår AI-jobbbeskrivelse generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike jobb beskrivelser basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange jobb beskrivelsesforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i beskrivelsesprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-jobbbeskrivelse generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer jobb beskrivelser med et verktøy som forstår kontekst og skaper originale, unike beskrivelser! Vår AI-jobbbeskrivelse generator er et verktøy du kan stole på for å produsere kreative og passende jobb beskrivelser av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer jobb beskrivelser kan AI-jobbbeskrivelse generatoren lage?",
    answer: "Vår AI-jobbbeskrivelse generator er allsidig og kan generere et bredt utvalg av jobb beskrivelser. Dette inkluderer tradisjonelle jobb beskrivelser, kreative beskrivelser for spesifikke roller, og til og med beskrivelser for fiktive stillinger."
  },
  {
    question: "Hvordan håndterer AI-jobbbeskrivelse generatoren personvernet ditt?",
    answer: "Vår AI-jobbbeskrivelse generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte jobb beskrivelser er til din eksklusive bruk."
  },
  {
    question: "Kan AI-jobbbeskrivelse generatoren din skape beskrivelser basert på spesifikke kriterier?",
    answer: "Ja, vår AI-jobbbeskrivelse generator kan justere beskrivelsesforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tone, eller til og med bestemte nøkkelord du vil at beskrivelsen skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-jobbbeskrivelse generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-jobbbeskrivelse generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende jobb beskrivelser."
  },
  {
    question: "Kan AI-jobbbeskrivelse generatoren din hjelpe med å finne sjeldne eller unike beskrivelser?",
