...
export default function AIWriterPage() {
  const customFields = {
    greentextTheme: {
      type: 'input' as const,
      label: 'Tema for greentext',
      placeholder: 'F.eks. "En dag på jobben", "Første date", etc.'
    },
    greentextLength: {
      type: 'input' as const,
      label: 'Ønsket lengde',
      placeholder: 'Kort, medium, eller lang'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Greentext Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Greentext Generator hjelper deg å skape unike og morsomme greentexts raskt og enkelt. Med dette verktøyet kan du generere kreative greentexts tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over kreative og morsomme greentexts basert på den gitte informasjonen. *Greentexts skal være i typisk 4chan-stil, korte og poengterte, og starte med '>' for hver ny linje. Tilpass lengden og tonen basert på brukerens input. Vær kreativ og humoristisk, men unngå støtende eller upassende innhold.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Greentext Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Greentext Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og morsomme greentexts basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte greentexten for underholdning, sosiale medier, eller til og med for personlig bruk, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din greentext!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-greentextgenerator som skaper unike tekster
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI-greentextgenerator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og unike greentexts som stemmer overens med dine spesifikke behov. Med vår AI-greentextgenerator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike greentexts basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange greentextsforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-greentextgenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer greentexts med et verktøy som forstår kontekst og skaper originale, unike tekster! Vår AI-greentextgenerator er et verktøy du kan stole på for å produsere kreative og passende greentexts av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer greentexts kan AI-greentextgeneratoren lage?",
    answer: "Vår AI-greentextgenerator er allsidig og kan generere et bredt utvalg av greentexts. Dette inkluderer morsomme, kreative og til og med fiktive greentexts for underholdning eller sosiale medier."
  },
  {
    question: "Hvordan håndterer AI-greentextgeneratoren personvernet ditt?",
    answer: "Vår AI-greentextgenerator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte greentexts er til din eksklusive bruk."
  },
  {
    question: "Kan AI-greentextgeneratoren din skape tekster basert på spesifikke kriterier?",
    answer: "Ja, vår AI-greentextgenerator kan justere tekstforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at teksten skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-greentextgeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI-greentextgenerator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende greentexts."
  },
  {
