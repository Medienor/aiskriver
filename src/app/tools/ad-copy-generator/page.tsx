...
export default function AIWriterPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Annonsebeskrivelser og Titler Generator</h1>
        <p className="text-sm md:text-base mb-6 md:mb-12 text-gray-500 dark:text-gray-400 mx-auto text-center max-w-2xl">
          Vår AI Annonsebeskrivelser og Titler Generator er et kraftfullt verktøy som hjelper deg å skape engasjerende annonsetekster raskt og effektivt. Med avansert kunstig intelligens kan du enkelt generere ideer, optimalisere innhold og utvikle kreative titler, noe som revolusjonerer hele annonseprosessen.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Du er en ekspert på å skrive annonsetekster og titler. Din oppgave er å generere engasjerende og overbevisende annonsetekster basert på den gitte produktinformasjonen og målgruppen. *Fokuser på å skape oppmerksomhetsvekkende titler, fremheve produktets fordeler, og bruke overbevisende språk som resonerer med målgruppen. Sørg for at annonseteksten er konsis, relevant og motiverer til handling.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Annonsebeskrivelser og Titler Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Annonsebeskrivelser og Titler Generator er et avansert verktøy som bruker kunstig intelligens for å hjelpe markedsførere med å skape engasjerende annonsetekster. Dette verktøyet kan assistere deg med å generere ideer, optimalisere innhold, utvikle kreative titler og til og med skrive utkast til annonser, noe som gjør hele annonseprosessen mer effektiv og kreativ.
          </p>
        </div>
      ...
      <section className="py-8">
        ...
        <p className="text-base mb-6 text-gray-700 dark:text-gray-300 text-center">
          Her er noen grunner til hvorfor Innhold.AI AI Annonsebeskrivelser og Titler Generator er et bedre valg enn ChatGPT BE
        </p>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Annonsebeskrivelser og Titler Generator som tenker som en markedsfører
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Innhold.AI AI Annonsebeskrivelser og Titler Generator er ikke en vanlig tekstgenerator. Det er en sofistikert assistent designet for å hjelpe markedsførere med å skape engasjerende og unike annonsetekster. Med Innhold.AI kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere kreative ideer og titler for dine annonser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Utvikle engasjerende og overbevisende annonsetekster.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Overkomme skriveblokkering og øke din produktivitet som markedsfører.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Originalt</span> innhold med AI Annonsebeskrivelser og Titler Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Skap unike og engasjerende annonsetekster med et verktøy som forstår kreativ skriving! Innhold.AI AI Annonsebeskrivelser og Titler Generator er en assistent du kan stole på for å produsere originalt innhold som inspirerer og engasjerer lesere.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer annonser kan AI Annonsebeskrivelser og Titler Generator hjelpe meg med?",
    answer: "Vår AI Annonsebeskrivelser og Titler Generator er allsidig og kan hjelpe deg med en rekke annonsetyper, inkludert sosiale medier, Google Ads, bannerannonser og mer. Den kan assistere med alt fra idégenerering og optimalisering til utvikling av kreative titler og annonsetekster."
  },
  {
    question: "Hvordan håndterer AI Annonsebeskrivelser og Titler Generator personvernet mitt?",
  ...
  {
    question: "Kan AI Annonsebeskrivelser og Titler Generator tilpasse seg ulike skrivestiler?",
