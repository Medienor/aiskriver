...
export default function AIWriterPage() {
  const customFields = {
    nameType: {
      type: 'input' as const,
      label: 'Type navn',
      placeholder: 'F.eks. karakter, sted, magisk gjenstand'
    },
    nameStyle: {
      type: 'input' as const,
      label: 'Navnestil',
      placeholder: 'F.eks. eldgammel, futuristisk, mystisk'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Fantasinavn Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Fantasinavn Generator hjelper deg å skape unike og kreative navn for dine karakterer eller verdener. Med dette kraftfulle verktøyet kan du raskt generere inspirerende fantasinavn tilpasset dine behov.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over unike og kreative fantasinavn basert på den gitte informasjonen. *Navnene skal være originale, passe til den spesifiserte typen (f.eks. karakter, sted, magisk gjenstand) og reflektere den ønskede stilen (f.eks. eldgammel, futuristisk, mystisk). Generer minst 10 navn, og sørg for at hvert navn er unikt og passer godt inn i en fantasiverden.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Fantasinavn Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Fantasinavn Generator er et avansert verktøy som bruker kunstig intelligens for å skape unike og kreative navn for karakterer, steder eller objekter i fantasiverdener. Dette verktøyet kan hjelpe forfattere, spilldesignere og rollespillentusiaster med å generere inspirerende navn raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Få unike fantasinavn!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI-fantasinavngenerator som skaper unike navn
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Fantasinavn Generator er ikke en hvilken som helst navngenerator. Den er designet for å levere kontekstuelt relevante og kreative navn som stemmer overens med dine spesifikke behov. Med vår generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere unike og kreative navn for karakterer, steder og objekter.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Skape store mengder fantasinavn i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og inspirere din kreative prosess med AI-genererte navn.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI-fantasinavngenerator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer fantasinavn med et verktøy som forstår kontekst og skaper originale, unike navn! Vår AI-fantasinavngenerator er et verktøy du kan stole på for å produsere kreative og passende navn for dine karakterer, steder og objekter i fantasiverdener.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer fantasinavn kan generatoren lage?",
    answer: "Vår AI-fantasinavngenerator er allsidig og kan generere et bredt utvalg av navn. Dette inkluderer navn for karakterer, steder, magiske gjenstander, raser, og mer. Du kan spesifisere hvilken type navn du ønsker for best mulig resultat."
  },
  {
    question: "Hvordan håndterer AI-fantasinavngeneratoren personvernet ditt?",
  ...
  {
    question: "Kan AI-fantasinavngeneratoren din skape navn i forskjellige stiler?",
    answer: "Ja, vår AI-fantasinavngenerator kan justere navnestilen basert på dine preferanser. Du kan spesifisere om du ønsker navn som høres eldgamle, futuristiske, mystiske eller annet ut, og generatoren vil tilpasse seg deretter."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI-fantasinavngeneratoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative fantasinavn."
  },
  {
    question: "Kan AI-fantasinavngeneratoren din hjelpe med å skape konsistente navn for en hel verden?",
