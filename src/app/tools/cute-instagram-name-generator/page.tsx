...
export default function AIWriterPage() {
  const customFields = {
    personalityTraits: {
      ...
      placeholder: 'Beskriv din personlighet eller stil (f.eks. kreativ, sporty, humoristisk)'
    },
    interests: {
      type: 'input' as const,
      label: 'Interesser',
      placeholder: 'Skriv inn dine hovedinteresser eller hobbyer'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Søte Instagram Navn Generator</h1>
        <p className="text-sm mb-6 md:mb-12 text-gray-500 dark:text-gray-400 mx-auto text-center max-w-2xl">
          Vår AI Søte Instagram Navn Generator hjelper deg å finne unike og kreative navn for din Instagram-konto. Med avansert kunstig intelligens kan du raskt generere sjarmerende og minneverdige navn som passer din stil og personlighet.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere kreative og søte Instagram-navn basert på brukerens personlighetstrekk og interesser. *Navnene skal være unike, minneverdige og reflektere brukerens personlighet. Inkluder en blanding av ord, tall og symboler hvis passende. Generer minst 5 forskjellige navn-alternativer.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Søte Instagram Navn Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Søte Instagram Navn Generator er et avansert verktøy som bruker kunstig intelligens for å produsere kreative og sjarmerende Instagram-navn basert på dine spesifikasjoner. Dette verktøyet kan hjelpe deg med å finne det perfekte navnet for din Instagram-konto raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg ditt Instagram-navn!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Instagram-navn generator som tenker som en kreativ ekspert
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Innhold.AI er ikke en hvilken som helst Instagram-navn generator. Det er en avansert AI-drevet assistent designet for å levere kreative, relevante og minneverdige Instagram-navn som stemmer overens med din stil og personlighet. Med Innhold.AI kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere unike og sjarmerende Instagram-navn som reflekterer din personlighet.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Instagram-navn generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer Instagram-navn med et verktøy som forstår din personlighet og skaper originale, unike forslag! Innhold.AI er en AI Instagram-navn generator du kan stole på for å produsere kreative og relevante navn som skiller seg ut i mengden.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer Instagram-navn kan AI Instagram-navn generatoren lage?",
    answer: "Vår AI Instagram-navn generator er allsidig og kan generere et bredt utvalg av navn. Dette inkluderer korte og catchy navn, beskrivende navn, brandable navn, og navn som passer til ulike stiler og personligheter."
  },
  {
    question: "Hvordan håndterer AI Instagram-navn generatoren personvernet ditt?",
    answer: "Innhold.AI er designet med tanke på personvern. Den deler ikke dine personlige data eller søkeord med ikke-relaterte parter uten ditt samtykke. Alle genererte navn eies utelukkende av deg."
  },
  {
    question: "Kan AI Instagram-navn generatoren din ta hensyn til spesifikke temaer eller interesser?",
    answer: "Ja, vår AI Instagram-navn generator kan tilpasse forslagene basert på dine spesifikke temaer eller interesser. Du kan angi nøkkelord eller beskrivelser relatert til din konto, og AI-en vil generere relevante navn."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Instagram-navn generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke Innhold.AI. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative Instagram-navn."
  },
  {
    question: "Kan AI Instagram-navn generatoren din hjelpe med SEO-vennlige navn?",
    answer: "Ja, vår AI Instagram-navn generator kan generere SEO-vennlige navn. Den kan inkludere relevante nøkkelord og skape navn som er lette å huske og skrive, noe som kan forbedre din online synlighet."
  },
  {
