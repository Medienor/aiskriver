...
export default function AIWriterPage() {
  const customFields = {
    personalInfo: {
      ...
      placeholder: 'Beskriv deg selv, dine interesser, hobbyer eller yrke'
    },
    bioStyle: {
      type: 'input' as const,
      label: 'Ønsket stil',
      placeholder: 'F.eks. profesjonell, humoristisk, kreativ'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Instagram Bio Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Instagram Bio Generator hjelper deg å skape unike og engasjerende biografier raskt og enkelt. Med dette verktøyet kan du generere kreative bio-forslag tilpasset dine spesifikke behov og preferanser.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over kreative og engasjerende Instagram-biografier basert på den gitte informasjonen. *Biografiene skal være på norsk, korte og passe innenfor Instagrams tegnbegrensning. Inkluder relevante emojis der det passer. Tilpass tonen og stilen basert på brukerens ønsker, og sørg for at biografiene er unike og reflekterer personens individualitet.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Instagram Bio Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Instagram Bio Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og engasjerende biografier basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å finne den perfekte biografien for din Instagram-profil, raskt og effektivt.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din biografi!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Instagram Bio Generator som skaper unike biografier
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Instagram Bio Generator er ikke en hvilken som helst biografiskaper. Den er designet for å levere kontekstuelt relevante og unike biografier som stemmer overens med dine spesifikke behov. Med vår AI Instagram Bio Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike biografier basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange bio-forslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Spare tid og kreativ energi i biografiprosessen.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Instagram Bio Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer biografier med et verktøy som forstår kontekst og skaper originale, unike bios! Vår AI Instagram Bio Generator er et verktøy du kan stole på for å produsere kreative og passende biografier av høy kvalitet.
            </p>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Unike bios</span>
                <motion.span 
...
const faqs = [
  {
    question: "Hvilke typer biografier kan AI Instagram Bio Generator lage?",
    answer: "Vår AI Instagram Bio Generator er allsidig og kan generere et bredt utvalg av biografier. Dette inkluderer kreative, profesjonelle, og til og med humoristiske biografier for din Instagram-profil."
  },
  {
    question: "Hvordan håndterer AI Instagram Bio Generator personvernet ditt?",
    answer: "Vår AI Instagram Bio Generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte biografier er til din eksklusive bruk."
  },
  {
    question: "Kan AI Instagram Bio Generator skape biografier basert på spesifikke kriterier?",
    answer: "Ja, vår AI Instagram Bio Generator kan justere bio-forslagene basert på dine preferanser. Du kan spesifisere ønsket tone, lengde, eller til og med bestemte ord du vil at biografien skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Instagram Bio Generator?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Instagram Bio Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende biografier."
  },
  {
    question: "Kan AI Instagram Bio Generator hjelpe med å finne sjeldne eller unike biografier?",
    answer: "Ja, vår AI Instagram Bio Generator er designet for å skape både vanlige og unike biografier. Du kan justere innstillingene for å generere sjeldnere eller mer unike bio-forslag."
  },
  {
    question: "Kan jeg bruke AI Instagram Bio Generator for å finne biografier fra forskjellige kulturer?",
