...
export default function AIWriterPage() {
  const customFields = {
    serviceType: {
      type: 'input' as const,
      label: 'Type tjeneste',
      placeholder: 'F.eks. grafisk design, webutvikling, oversettelse'
    },
    keyFeatures: {
      type: 'textarea' as const,
      label: 'Nøkkelfunksjoner',
      placeholder: 'List opp de viktigste funksjonene eller fordelene ved din tjeneste'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Fiverr Beskrivelse Generator</h1>
        <p className="text-sm mb-6 md:mb-10 text-gray-500 dark:text-gray-400 text-center max-w-2xl mx-auto">
          Vår AI Fiverr Beskrivelse Generator hjelper deg å lage unike og profesjonelle beskrivelser for dine Fiverr-tjenester raskt og enkelt. Med dette verktøyet kan du generere kreative og tilpassede beskrivelser som tiltrekker seg flere kunder.
        </p>
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en overbevisende og profesjonell Fiverr-tjenestebeskrivelse basert på den gitte informasjonen. *Beskrivelsen skal være på norsk, fremheve de unike sellingspunktene ved tjenesten, og være optimalisert for å tiltrekke potensielle kunder. Inkluder en klar beskrivelse av tjenesten, dens fordeler, og hvorfor kjøperen bør velge denne tjenesten. Sørg for at språket er engasjerende, konkret og tilpasset Fiverr-plattformen.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Fiverr Beskrivelse Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Fiverr Beskrivelse Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og profesjonelle beskrivelser for dine Fiverr-tjenester. Dette verktøyet kan hjelpe deg med å finne den perfekte beskrivelsen for å tiltrekke flere kunder og øke salget.
          </p>
        </div>
          ...
          <div className="bg-[#f3f4f6] dark:bg-gray-800 p-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">Velg din beskrivelse!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Fiverr Beskrivelse Generator som skaper unike beskrivelser
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Fiverr Beskrivelse Generator er ikke en hvilken som helst tekstgenerator. Den er designet for å levere kontekstuelt relevante og unike beskrivelser som stemmer overens med dine spesifikke behov. Med vår AI Fiverr Beskrivelse Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike beskrivelser basert på dine preferanser.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Få mange beskrivelsesforslag i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Fiverr Beskrivelse Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer beskrivelser med et verktøy som forstår kontekst og skaper originale, unike tekster! Vår AI Fiverr Beskrivelse Generator er et verktøy du kan stole på for å produsere kreative og passende beskrivelser av høy kvalitet.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer beskrivelser kan AI Fiverr Beskrivelse Generatoren lage?",
    answer: "Vår AI Fiverr Beskrivelse Generator er allsidig og kan generere et bredt utvalg av beskrivelser. Dette inkluderer profesjonelle, kreative og tilpassede beskrivelser for dine Fiverr-tjenester."
  },
  {
    question: "Hvordan håndterer AI Fiverr Beskrivelse Generatoren personvernet ditt?",
    answer: "Vår AI Fiverr Beskrivelse Generator er designet med tanke på personvern. Den lagrer ikke personlige data og deler ikke informasjon med tredjeparter. Alle genererte beskrivelser er til din eksklusive bruk."
  },
  {
    question: "Kan AI Fiverr Beskrivelse Generatoren din skape beskrivelser basert på spesifikke kriterier?",
    answer: "Ja, vår AI Fiverr Beskrivelse Generator kan justere tekstforslagene basert på dine preferanser. Du kan spesifisere ønsket lengde, tema, eller til og med bestemte ord du vil at teksten skal inneholde."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Fiverr Beskrivelse Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Fiverr Beskrivelse Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og passende beskrivelser."
  },
  {
    question: "Kan AI Fiverr Beskrivelse Generatoren din hjelpe med å finne sjeldne eller unike beskrivelser?",
    answer: "Ja, vår AI Fiverr Beskrivelse Generator er designet for å skape både vanlige og unike beskrivelser. Du kan justere innstillingene for å generere sjeldnere eller mer unike beskrivelsesforslag."
  },
  {
