...
export default function AIWriterPage() {
  const customFields = {
    nameType: {
      type: 'input' as const,
      label: 'Type navn',
      placeholder: 'F.eks. karakter, bedrift, produkt'
    },
    nameStyle: {
      type: 'input' as const,
      label: 'Navnestil',
      placeholder: 'F.eks. moderne, klassisk, fantasy'
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-24">
      <section>
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 text-center">AI Navne Generator</h1>
        ...
        <AIWriterPanel 
          hiddenPrompt="Din oppgave er å generere en liste over unike og kreative navn basert på den gitte informasjonen. *Navnene skal være tilpasset den spesifiserte typen (f.eks. karakter, bedrift, produkt) og stilen (f.eks. moderne, klassisk, fantasy). Generer minst 10 forskjellige navn som er originale, minneverdige og relevante for den angitte konteksten.*" 
      ...
      <section className="flex flex-col lg:flex-row gap-8 py-8">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Hva er en AI Navne Generator?</h2>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
            En AI Navne Generator er et avansert verktøy som bruker kunstig intelligens for å produsere unike og kreative navn basert på gitte kriterier. Dette verktøyet kan hjelpe deg med å skape passende navn raskt og effektivt, enten det er for karakterer i en bok, nye produkter, eller til og med for bedrifter.
          </p>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100">
              AI Navne Generator som skaper unike navn
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Vår AI Navne Generator er ikke en hvilken som helst navnegenerator. Det er et avansert verktøy designet for å levere kontekstuelt relevante og unike navn som stemmer overens med dine spesifikke behov. Med vår AI Navne Generator kan du:
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">Generere høykvalitets, unike navn i en rekke stiler og kategorier.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700 dark:text-gray-300">Lag store mengder navn i løpet av sekunder.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">
              <span className="text-blue-600 dark:text-blue-400">Unik</span> AI Navne Generator
            </h2>
            <p className="text-base mb-6 text-gray-700 dark:text-gray-300">
              Generer unike navn med et verktøy som forstår kontekst og skaper originale, kreative forslag! Vår AI Navne Generator er et verktøy du kan stole på for å produsere navn av høy kvalitet som skiller seg ut i mengden.
            </p>
...
const faqs = [
  {
    question: "Hvilke typer navn kan AI Navne Generatoren lage?",
    answer: "Vår AI Navne Generator er allsidig og kan generere et bredt utvalg av navnetyper. Dette inkluderer personnavn, bedriftsnavn, produktnavn, karakternavn for bøker eller spill, og mange flere."
  },
  {
    question: "Hvordan håndterer AI Navne Generatoren personvernet ditt?",
    answer: "Vår AI Navne Generator er designet med tanke på personvern. Den deler ikke dine personlige data med ikke-relaterte parter uten ditt samtykke. Alle genererte navn eies utelukkende av deg."
  },
  {
    question: "Kan AI Navne Generatoren din lage navn i forskjellige stiler?",
    answer: "Ja, vår AI Navne Generator kan justere navnestilen basert på dine preferanser. Du kan spesifisere om du ønsker moderne navn, klassiske navn, fantasinavn, eller andre stiler for å få navn som passer perfekt til ditt behov."
  },
  {
    question: "Trenger jeg noen spesielle ferdigheter for å bruke denne AI Navne Generatoren?",
    answer: "Nei, du trenger ingen spesielle ferdigheter for å bruke vår AI Navne Generator. Det brukervennlige grensesnittet gjør det enkelt for alle å generere kreative og unike navn."
  },
  {
