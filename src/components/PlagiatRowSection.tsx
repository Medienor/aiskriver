...
interface PlagiatRowSectionProps {
  onButtonClick: () => void;
}

export default function PlagiatRowSection({ onButtonClick }: PlagiatRowSectionProps) {
        ...
        <div className="w-full max-w-7xl bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
          <div className="flex flex-col md:flex-row md:space-x-12">
            ...
            <div className="w-full md:w-1/2 relative mt-8 md:mt-0">
              <div className="md:absolute md:inset-0 pt-4 md:pt-8 pr-4 md:pr-8">
